...
<html>
    <head>
        ...
        <title>Food Corner - Recipe Book</title>
    ...
    <section class="page-heading">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Recipe Book</h1>
                    <p>Discover different recipes, Enjoy delicious, unforgettable meals, cooked from scratch and fresh ingredients deliver at your doorstep .</p>
                </div>
            </div>
        </div>
    </section>
